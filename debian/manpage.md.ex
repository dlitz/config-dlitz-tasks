% config-dlitz-tasks(SECTION) | User Commands
%
% "August  8 2023"
...
config-dlitz-tasks - program to do something

# SYNOPSIS

**config-dlitz-tasks** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**config-dlitz-tasks** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **config-dlitz-tasks** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**config-dlitz-tasks** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    config-dlitz-tasks. See **foo.conf**(5) for further details.
...
**config-dlitz-tasks** provides some return codes, that can be used in scripts:
